...
class ENUM_APPLIED_PRICE(Enum):
    ...
    def get_price(p):
        ...
        if p.lower() == ENUM_APPLIED_PRICE.HL2.value.lower(): return ENUM_APPLIED_PRICE.HL2
        if p.lower() == ENUM_APPLIED_PRICE.HLC3.value.lower(): return ENUM_APPLIED_PRICE.HLC3
        return None
